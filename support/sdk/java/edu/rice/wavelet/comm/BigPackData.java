 ...
 * This class implements a Java interface to the 'BigPackData'
 * message type.
 */

package edu.rice.wavelet.comm;

public class BigPackData extends net.tinyos.message.Message {
    ...
    /** Create a new BigPackData of size 21. */
    public BigPackData() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new BigPackData of the given data_length. */
    public BigPackData(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new BigPackData with the given data_length
     * and base offset.
     */
    public BigPackData(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new BigPackData using the given byte array
     * as backing store.
     */
    public BigPackData(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public BigPackData(byte[] data, int base_offset) {
     ...
     */
    public BigPackData(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new BigPackData embedded in the given message
     * at the given base offset.
     */
    public BigPackData(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public BigPackData(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <BigPackData> \n";
      try {
        s += "  [curPack=0x"+Long.toHexString(get_curPack())+"]\n";
    ...
    /////////////////////////////////////////////////////////
    // Accessor methods for field: curPack
    ...
    /**
     * Return whether the field 'curPack' is signed (false).
     */
    public static boolean isSigned_curPack() {
        return false;
    }

    /**
     * Return whether the field 'curPack' is an array (false).
     */
    public static boolean isArray_curPack() {
        return false;
    }

    /**
     * Return the offset (in bytes) of the field 'curPack'
     */
    public static int offset_curPack() {
        return (0 / 8);
    }

    /**
     * Return the offset (in bits) of the field 'curPack'
     */
    public static int offsetBits_curPack() {
        return 0;
    }

    /**
     * Return the value (as a short) of the field 'curPack'
     */
    public short get_curPack() {
        return (short)getUIntElement(offsetBits_curPack(), 8);
    }

    /**
     * Set the value of the field 'curPack'
     */
    public void set_curPack(short value) {
        setUIntElement(offsetBits_curPack(), 8, value);
    }

    /**
     * Return the size, in bytes, of the field 'curPack'
     */
    public static int size_curPack() {
        return (8 / 8);
    }

    /**
     * Return the size, in bits, of the field 'curPack'
     */
    public static int sizeBits_curPack() {
        return 8;
    }
